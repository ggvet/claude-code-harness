...
| harness-command-center | Project Command Center TOP — 3-panel mission control over sibling projects + sessions (Phase 65.6) | "プロジェクト全体", "ダッシュボード", "TOP 画面", "mission control" |
